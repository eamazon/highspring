/**
-- Script Name: 26_sp_Load_Bridge_CF_Segment_Patient_Snapshot.sql
-- Description: Build monthly patient-level CF segment snapshots from Unified SUS (IP/OP).
...
IF OBJECT_ID('[Analytics].[sp_Load_Bridge_CF_Segment_Patient_Snapshot]', 'P') IS NOT NULL
    DROP PROCEDURE [Analytics].[sp_Load_Bridge_CF_Segment_Patient_Snapshot];
GO

CREATE PROCEDURE [Analytics].[sp_Load_Bridge_CF_Segment_Patient_Snapshot]
...
BEGIN
    ...
    DECLARE @BatchName VARCHAR(100) = 'Bridge_CF_Segment_Patient_Snapshot';
    ...
    PRINT 'Loading CF Segment Patient Snapshot';
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            DELETE FROM [Analytics].[tbl_Bridge_CF_Segment_Patient_Snapshot]
            ...
            INSERT INTO [Analytics].[tbl_Bridge_CF_Segment_Patient_Snapshot] (
                [Snapshot_Month],
                [Snapshot_End_Date],
                [SK_PatientID],
                [Segment_Type],
            ...
            SELECT
                ...
                @SnapshotEnd AS Snapshot_End_Date,
                p.SK_PatientID,
        ...
        EXEC [Analytics].[sp_Log_Table_Load]
            @BatchID = @BatchID,
            @TableName = 'Analytics.tbl_Bridge_CF_Segment_Patient_Snapshot',
            @LoadType = 'Full',
    ...
    BEGIN CATCH
        ...
        PRINT 'Error Loading CF Segment Patient Snapshot: ' + @ErrorMessage;
