...
Change Log:
  ...
  2026-03-12  Sridhar Peddi    Preserve existing staging data (create table only if missing)
**/
...
ELSE
BEGIN
    PRINT '[SKIP] Table [Analytics].[tbl_Staging_LSOA_IMD2019] already exists - preserving staged data';
END
GO
